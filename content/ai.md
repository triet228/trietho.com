...
All you need to do it connect a cable (USB A or USB C) to your laptop, and you are ready to run powerful open-source AI models. 
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 my-10">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 flex flex-col hover:shadow-2xl transition-all duration-300">
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/fZu7sMcRU8fpeHn7hJ5EY00" icon="credit-card" style="outline" >}}Purchase{{< /button >}}
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 flex flex-col hover:shadow-2xl transition-all duration-300">
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/28E9AU9FI53d6aR9pR5EY01" icon="credit-card" style="outline" >}}Purchase{{< /button >}}
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 flex flex-col hover:shadow-2xl transition-all duration-300">
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/cNicN65ps8fp6aR7hJ5EY02" icon="credit-card" style="outline" >}}Purchase{{< /button >}}
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border-2 border-blue-500 dark:border-blue-500 p-6 flex flex-col hover:-translate-y-1 transition-all duration-300 relative">
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/5kQcN6bNQ0MXbvbdG75EY03" icon="credit-card" style="primary" >}}Purchase{{< /button >}}
    </div>
  </div>

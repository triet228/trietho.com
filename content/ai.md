...
### Triet Plug-and-Play Local AI Box 

Bring private local AI to your laptop. Connect a cable, and you are ready to run powerful open-source AI models on any laptop. 
...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-6 my-10">
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 flex flex-col hover:shadow-2xl transition-all duration-300">
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/fZu7sMcRU8fpeHn7hJ5EY00" icon="credit-card" style="outline" >}}Purchase Base Option{{< /button >}}
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 flex flex-col hover:shadow-2xl transition-all duration-300">
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/28E9AU9FI53d6aR9pR5EY01" icon="credit-card" style="outline" >}}Purchase Budget Option{{< /button >}}
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 flex flex-col hover:shadow-2xl transition-all duration-300">
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/cNicN65ps8fp6aR7hJ5EY02" icon="credit-card" style="outline" >}}Purchase Economy Option{{< /button >}}
    </div>
  </div>

  <!-- Premium Card -->
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border-2 border-blue-500 dark:border-blue-500 p-6 flex flex-col hover:-translate-y-1 transition-all duration-300 relative">
    <div class="absolute top-0 right-0 bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-xl">PRO</div>
    ...
    <div class="mt-auto text-center">
      {{< button url="https://buy.stripe.com/5kQcN6bNQ0MXbvbdG75EY03" icon="credit-card" style="primary" >}}Purchase Premium Option{{< /button >}}
    </div>
  </div>
